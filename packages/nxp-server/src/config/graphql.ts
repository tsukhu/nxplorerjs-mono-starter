...
import { fetchPeople, fetchPeopleWithPlanet, fetchPlanet, fetchStarship } from '../graphql/dataloader/starwars';
import StarwarsAPI from '../graphql/datasource/starwars-api';
import { mocks, resolvers, schemaDirectives, typeDefs } from '../graphql/setupSchema';
