 ...
 * @param apiPath API YAML File path
 */
export const swaggerify = (app: Application, apiPath: string) => {
  // Add Swagger support
  swaggerMiddleware(apiPath, app, (err, middleware) => {
  ...
  const swaggerDocument = YAML.load(apiPath);
